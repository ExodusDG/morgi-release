...
const ThirdPage = (props) => {
  ...
  return (
    <>
      <HeroSection color="gradient" whiteBlock={true} thirdScroll={true} lang={props.langData} />
      <RecipeSection lang={props.langData} />
      <WaysSection text="The Power of Morgi's Monetization: 4 Fantastic Options" lang={props.langData} />
